          ...
          children: <Widget>[
            ExpansionTile(
              title: Text(
                ...
                style: TextStyle(
                  letterSpacing: 1.0,
                  color: dimensionIsExpanded ? HexColor('#E07B36') : Colors.black,
                ),
              ),
            ...
            ExpansionTile(
              title: Text(
                ...
                style: TextStyle(
                  letterSpacing: 1.0,
                  color: engineIsExpanded ? HexColor('#E07B36') : Colors.black,
                ),
              ),
              onExpansionChanged: (bool val) {
            ...
            ExpansionTile(
              title: Text(
                ...
                style: TextStyle(
                  letterSpacing: 1.0,
                  color: performanceIsExpanded ? HexColor('#E07B36') : Colors.black,
                ),
              ),
              onExpansionChanged: (bool val) {
            ...
            ExpansionTile(
              title: Text(
                ...
                style: TextStyle(
                  letterSpacing: 1.0,
                  color: safetyIsExpanded ? HexColor('#E07B36') : Colors.black,
                ),
              ),
              onExpansionChanged: (bool val) {
            ...
            ExpansionTile(
              title: Text(
                ...
                style: TextStyle(
                  letterSpacing: 1.0,
                  color: capacityIsExpanded ? HexColor('#E07B36') : Colors.black,
                ),
              ),
              onExpansionChanged: (bool val) {
